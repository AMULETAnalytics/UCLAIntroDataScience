...
# Add S-shaped "sigmoid" function to plot which shows the dichotomist
# nature of the algorithm. Notice how the y-axis shows values of
# isVersicolor between 0 and 1, thus representing the probabilities
# for different values in the training set for Sepal.Width
...
# Once trained, we can the model to make predictions for the
